...
@interface FCTargetClientVC ()<UITableViewDelegate,UITableViewDataSource,FCHouseMoreViewDelegate,FCHouseMoreViewDataSource,FCHouseFollowCellDelegate>
...
@implementation FCTargetClientVC
...
-(NSMutableArray *)moreObjects
{
    if (_moreObjects == nil) {
        ...
        FCHouseMoreObject *object4 = [[FCHouseMoreObject alloc] init];
        object4.cateName = @"转换流失";
        object4.imageName = @"转换流失";
        [_moreObjects addObject:object4];
    }
    return _moreObjects;
}
