...
@interface FCVisitNoteVC ()<UITableViewDelegate,UITableViewDataSource,FCHouseFollowCellDelegate>
...
@implementation FCVisitNoteVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"带看记录"];
    [self setUpTableView];
    [self setUpRefresh];
    [self setUpEmptyView];
}
