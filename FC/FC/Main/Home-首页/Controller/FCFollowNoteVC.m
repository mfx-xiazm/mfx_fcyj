...
@interface FCFollowNoteVC ()<JXCategoryViewDelegate,UIScrollViewDelegate,UITextFieldDelegate>
...
-(NSArray *)childVCs
{
    if (_childVCs == nil) {
        ...
        for (int i=0;i<self.categoryView.titles.count;i++) {
            FCFollowNoteChildVC *cvc0 = [FCFollowNoteChildVC new];
