...
@interface FCMsgDetailVC ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, strong) WKWebView  *webView;
/* 网页加载进度视图 */
@property (nonatomic, strong) UIProgressView *progressView;
@end

@implementation FCMsgDetailVC
...
- (void)viewDidLoad {
    ...
    NSString *h5 = [NSString stringWithFormat:@"<html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=no\"><style>img{width:100%%; height:auto;}body{margin:12px 12px;}</style></head><body><div style=\"font-size:14px;font-weight:600;\">%@</div><div style=\"font-size:10px;color:#999999;padding:10px 0px;\">%@</div>%@</body></html>",@"消息标题消息标题消息标题这里是标题",@"2019-09-01  12:00",@"尊敬的客户，这里是公告详情，请仔细阅读请仔细阅读请仔细阅读请仔细阅请仔细阅读请仔细阅读这里是公告详情，请仔细阅读请仔细阅读请仔细阅读。请仔细阅请仔细阅读请仔细阅读这里是公告详情，请仔细阅读请仔细阅读请仔细阅读.请仔细阅请仔细阅读请仔细阅读这里是公告详情，请仔细阅读请仔细阅读请仔细阅读.请仔细阅请仔细阅读请仔细阅读这里是公告详情，请仔细阅读请仔细阅读请仔细阅读"];
