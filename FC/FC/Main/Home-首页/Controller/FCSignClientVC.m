...
@interface FCSignClientVC ()<UITableViewDelegate,UITableViewDataSource,FCHouseMoreViewDelegate,FCHouseMoreViewDataSource,FCHouseFollowCellDelegate>
...
-(NSMutableArray *)moreObjects
{
    if (_moreObjects == nil) {
        ...
        object4.cateName = @"转换未租";
        object4.imageName = @"转换未租";
