...
@interface FCClientFollowVC ()<UITableViewDelegate,UITableViewDataSource,FCHouseFollowCellDelegate>
...
@implementation FCClientFollowVC
...
-(void)setUpNavBar
{
    [self.navigationItem setTitle:@"全部记录"];
}
-(void)setUpTableView
{
