...
@interface FCHotelDetailVC ()<TYCyclePagerViewDataSource,TYCyclePagerViewDelegate,UITableViewDelegate,UITableViewDataSource,FCHotelCommentCellDelegate>
/* 轮播图 */
...
@implementation FCHotelDetailVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"民宿详情"];
    [self setUpCycleView];
    [self setUpTableView];
...
{
    FCHotelCommentLayout *layout = Cell.commentLayout;
