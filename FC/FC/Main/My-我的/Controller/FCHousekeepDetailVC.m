...
@interface FCHousekeepDetailVC ()<TYCyclePagerViewDataSource,TYCyclePagerViewDelegate>
/* 轮播图 */
...
@implementation FCHousekeepDetailVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"家政服务详情"];
    [self setUpCycleView];
