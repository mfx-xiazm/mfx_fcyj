...
@interface FCMyMsgVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *tableViewHeight;

@end

@implementation FCMyMsgVC
...
-(void)setUpNavBar
{
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithTarget:self action:@selector(changeClicked) nomalImage:HXGetImage(@"修改") higeLightedImage:HXGetImage(@"修改") imageEdgeInsets:UIEdgeInsetsZero];
}
-(void)setUpTableView
{
...
-(void)changeClicked
{
    FCChangeMyMsgVC *cvc = [FCChangeMyMsgVC new];
