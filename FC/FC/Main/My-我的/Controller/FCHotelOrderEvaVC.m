...
@interface FCHotelOrderEvaVC ()<UICollectionViewDelegate,UICollectionViewDataSource,ZLCollectionViewBaseFlowLayoutDelegate>
...
@implementation FCHotelOrderEvaVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"评价"];
    self.remark.placeholder = @"请输入评价内容";
